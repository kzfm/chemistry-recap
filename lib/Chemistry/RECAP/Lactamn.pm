package Chemistry::RECAP::Lactamn;
...
Chemistry::RECAP::Lactamn - The great new Chemistry::RECAP::Lactamn!
...
Perhaps a little code snippet.
    ...
    my $foo = Chemistry::RECAP::Lactamn->new();
    ...
...
sub cleave {
  ...
  for my $fragment (@fragments) {
    ...
    while ($self->{pattern}->match($fragment)){
      ...
      $bd[1]->delete;
      $fg[1]->implicit_hydrogens($fg[1]->implicit_hydrogens()+1);
      $fg[2]->implicit_hydrogens($fg[2]->implicit_hydrogens()+1);
    }
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Chemistry::RECAP::Lactamn
...
1; # End of Chemistry::RECAP::Lactamn
