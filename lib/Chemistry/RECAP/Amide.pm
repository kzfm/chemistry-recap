...
Chemistry::RECAP::Amide - RECAP Rule 1 (Amide)
...
Perhaps a little code snippet.
    ...
    my $foo = Chemistry::RECAP::Amide->new();
    $foo->cleave(@fragments);
...
1; # End of Chemistry::RECAP::Amide
