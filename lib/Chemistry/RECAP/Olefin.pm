package Chemistry::RECAP::Olefin;
...
Chemistry::RECAP::Olefin - The great new Chemistry::RECAP::Olefin!
...
Perhaps a little code snippet.
    ...
    my $foo = Chemistry::RECAP::Olefin->new();
    ...
...
sub cleave {
  ...
  for my $fragment (@fragments) {
    ...
    while ($self->{pattern}->match($fragment)){
      ...
      $bd[2]->delete;
      $fg[1]->implicit_hydrogens($fg[1]->implicit_hydrogens()+2);
      $fg[3]->implicit_hydrogens($fg[3]->implicit_hydrogens()+2);
    }
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Chemistry::RECAP::Olefin
...
1; # End of Chemistry::RECAP::Olefin
