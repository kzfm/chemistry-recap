package Chemistry::RECAP::Qnitrogen;
...
Chemistry::RECAP::Qnitrogen - The great new Chemistry::RECAP::Qnitrogen!
...
Perhaps a little code snippet.
    ...
    my $foo = Chemistry::RECAP::Qnitrogen->new();
    ...
...
sub cleave {
  ...
  for my $fragment (@fragments) {
    ...
    while ($self->{pattern}->match($fragment)){
      ...
      $fg[4]->implicit_hydrogens($fg[4]->implicit_hydrogens()+1);
    }
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Chemistry::RECAP::Qnitrogen
...
1; # End of Chemistry::RECAP::Qnitrogen
