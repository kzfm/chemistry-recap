...
Chemistry::RECAP::Ether - The great new Chemistry::RECAP::Ether!
...
Perhaps a little code snippet.
    ...
    my $foo = Chemistry::RECAP::Ether->new();
    ...
...
1; # End of Chemistry::RECAP::Ether
