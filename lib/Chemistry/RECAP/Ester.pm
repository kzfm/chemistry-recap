...
Chemistry::RECAP::Ester - The great new Chemistry::RECAP::Ester!
...
Perhaps a little code snippet.
    ...
    my $foo = Chemistry::RECAP::Ester->new();
    ...
...
1; # End of Chemistry::RECAP::Ester
