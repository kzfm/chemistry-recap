...
Chemistry::RECAP::Amine - The great new Chemistry::RECAP::Amine!
...
Perhaps a little code snippet.
    ...
    my $foo = Chemistry::RECAP::Amine->new();
    ...
...
1; # End of Chemistry::RECAP::Amine
