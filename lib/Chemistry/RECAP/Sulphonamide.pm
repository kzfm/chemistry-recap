package Chemistry::RECAP::Sulphonamide;
...
Chemistry::RECAP::Sulphonamide - The great new Chemistry::RECAP::Sulphonamide!
...
Perhaps a little code snippet.
    ...
    my $foo = Chemistry::RECAP::Sulphonamide->new();
    ...
...
sub cleave {
  ...
  for my $fragment (@fragments) {
    ...
    while ($self->{pattern}->match($fragment)){
      ...
      my $o = $fragment->new_atom(symbol => "O");
      $fragment->new_bond(atoms => [$o, $fg[1]], order => '1');
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Chemistry::RECAP::Sulphonamide
...
1; # End of Chemistry::RECAP::Sulphonamide
